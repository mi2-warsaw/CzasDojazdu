...
#                  titlePanel(HTML('<a style="color:#5882FA; font-size:32px; font-family:Verdana; line-height:0.4; text-decoration:none;" href="https://avinashr.shinyapps.io/Smart_Cities_India"> Czas dojazdu</a>'), windowTitle = "Czas dojazdu"),
                 titlePanel(HTML('<a style="color:#5882FA; font-size:32px; font-family:Verdana; line-height:0.4; text-decoration:none;"> Czas dojazdu</a>'), windowTitle = "Czas dojazdu"),
                 
                 #                titlePanel(HTML('<a style="color:#FF9933; font-size:32px; font-family:Verdana; line-height:0.4; text-decoration:none;" Czas dojazdu </a>'), windowTitle = "Czas dojazdu"),
                 ...
                 tabPanel(tags$h3(tags$b("O projekcie")),
                          ...
                          div(
                            ...
                            HTML('<p style="font-size:24px; font-family:Verdana;"align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Dziala swietnie, nie ma lepszej. Polecam.</p>'),
